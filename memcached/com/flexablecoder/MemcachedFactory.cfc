<cfcomponent name="MemcachedFactory" hint="The Factory for Memcached, should be a scope singleton">
	...
	<cffunction name="init" access="public" returntype="com.flexablecoder.MemcachedFactory" output="false"
		...
		<cfscript>
			...
			setMemcached(createObject("component", "com.flexablecoder.Memcached").init(arguments.servers));
