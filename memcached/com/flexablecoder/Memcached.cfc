<cfcomponent  extends="_base"  output="false">
	...
	<cffunction name="add" displayname="add" access="public" output="false" returntype="any"
		...
		<cfscript>
			...
			var ret = "";
			try {
				ret = getMemcached().add(arguments.key, arguments.expiry, serialize(arguments.value) );
			} catch (Any e)	{
				// failing gracefully
	...
	<cffunction name="doReplace" access="public" output="false" returntype="any"
		...
		<cfscript>
			...
			var ret = "";
			try	{
				ret = getMemcached().replace(arguments.key,arguments.expiry,serialize(arguments.value));
			} catch (Any e)	{
				// failing gracefully
				ret = "";
	...
	<cffunction name="set" access="public" output="false" returntype="any"
		...
		<cfscript>
			...
			var ret = "";
			try 	{
				ret = getMemcached().set(arguments.key,arguments.expiry,serialize(arguments.value));
			}  catch (Any e)	{
				// failing gracefully
				ret = "";
